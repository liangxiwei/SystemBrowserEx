...
//        a.recycle();
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        if (mHorizontal) {
            ...
            final int span = (int) (getChildAt(0).getRight() - getScaleX() - bottomEdge);
            if (span < length) {
            ...
            final int span = (int) (getChildAt(0).getBottom() - getScaleY() - bottomEdge);
            if (span < length) {
                return span / (float) length;
            }
        }
