 ...
 */
package com.amen.browser.search;
...
//        ComponentName name = searchManager.getWebSearchActivity();
    ...
    public Cursor getSuggestions(Context context, String query) {
        try {
            SearchManager searchManager =
                    (SearchManager) context.getSystemService(Context.SEARCH_SERVICE);
            Method method = searchManager.getClass().getDeclaredMethod("getSuggestions", mSearchable.getClass(),query.getClass());
            method.setAccessible(true);
            return (Cursor) method.invoke(searchManager, mSearchable,query);
